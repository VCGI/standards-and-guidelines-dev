...
- Replace the practice of mapping "inactive" parcels on a separate data layer and instead map all separate parcels individually, regardless of common ownership.
