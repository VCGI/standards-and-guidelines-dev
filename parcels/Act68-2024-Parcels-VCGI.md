...
- Replace the practice of mapping and tracking "inactive" parcels on a separate data layer and instead map and track all separate parcels individually, regardless of common ownership.
