...
## 1.1 Summary
- While functional for tax administration, the current parcel definition has limitations for valuation, data management, documentation, and analysis that informs parcel-based policy
