...
## 1.1 Summary
- While functional for tax administration, the current parcel definition has limitations for valuation, data management, documentation, and parcel-based analysis that informs policy
