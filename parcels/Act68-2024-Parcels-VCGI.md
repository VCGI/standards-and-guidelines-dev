...
## 1.1 Summary
- Change the current parcel definition from solely a "contiguous" parcel defintition to one that also requries tracking of separate and sellable pieces of real estate
...
*Figure 1: Existing contiguous parcel definition, depicted as in the current column on the left, and the proposed separate parcel defintion, depicted as the proposed column on the right. The proposed separate parcel definition removes the need for tracking "inactive" parcels.*
