...
Vermont has 256 municipalities: 237 towns, 10 cities, 5 unincorporated towns, and 4 gores. Municipalities the are source of grand list maintenance and related parcel mapping of taxable lands in their towns. Experience in working with towns suggests that it makes sense to continue to keep mapping as the responsibility of those who are also maintaining a grand list rather than separate these functions.

The ongoing effort to publish parcel map data joined to the annual statewide grand list in a uniform, digital format relies on municipalities voluntarily sharing updated parcel geometry with VCGI. These data are then made publicly available in a uniform, accessible way, driving applications such as the [Vermont Parcel Viewer](https://maps.vcgi.vermont.gov/ParcelViewer/) that draws more than 500,000 unique views a year, and as raw spatial data that sees more than 1 million unique views a year. Parcel data sourced in this voluntary way are now one of the State of Vermont's most-used spatial datasets, supporting efforts in emergency management, natural resources policy and planning, permitting and compliance, transportation, and in the address of pressing current issues such as flood response, resilience planning, and housing.

While relatively successful, there are improvements that are needed in this current town-sourced model of parcel data maintenance and publishing. About 60% of municipalities have submitted updated parcel geometry to VCGI within the last year. In contrast, about 16% of municipalities have not submitted updated parcel geometry to VCGI in over three years, indicating a divide in participation in the Parcel Program and limitations to its voluntary model. Inaccurate, untimely data impacts downstream uses that are now dependent on this information. A financial incentive to assist municipalities with the cost of parcel mapping that is contingent on parcel geometry submissions to VCGI could be designed to close this “participation gap” while improving data quality. Creating incentives to increase data maintenance and sharing was also a recommended consideration in the [2015 Vermont Statewide Digital Parcel Lifecycle & Maintenance Plan](https://vcgi.vermont.gov/sites/vcgiupdate/files/doc_library/VT_Parcel%20Data%20Lifecycle%20and%20Maintenance%20Plan_2015_FINAL.pdf):
...
-	12% of submissions are/have been reviewed by towns prior to submittal; 64% have not, and 24% are unknown. Some vendors are already working closely with towns as edits are being made (or edits are only being made at the direction of a town official), which may negate the need for a more formal review of the data prior to submission

## 2.3 Design

The design of a financial incentive to reward parcel data upkeep and quality improvements that is contingent on data submittal to the State should consider Municipal maintenance costs, and potentially, ways of accounting for differences by location and/or situation.
