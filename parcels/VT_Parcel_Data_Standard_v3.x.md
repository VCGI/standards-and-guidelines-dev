...
Parcel data are uniformly joined with the annual, statewide Grand List. If desired, towns can link parcel data to their internal Grand Lists or CAMA products to display even more local information. Officials can show taxpayers how proposed development or changes in municipal services and regulations will affect them and their neighbors. In many towns, parcel data also help to provide public notices, allocate resources, and carry out other municipal services.
